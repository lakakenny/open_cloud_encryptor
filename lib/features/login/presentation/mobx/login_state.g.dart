...
mixin _$LoginState on _LoginState, Store {
  final _$successAtom = Atom(name: '_LoginState.success');
  ...
  final _$loadingAtom = Atom(name: '_LoginState.loading');
  ...
  final _$isLoggedInAtom = Atom(name: '_LoginState.isLoggedIn');
